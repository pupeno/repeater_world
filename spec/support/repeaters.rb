...
RSpec.shared_context "repeaters" do
  before(:context) do
    ...
    create(:repeater,
      ...
      fm: true, fm_ctcss_tone: 94.8, fm_tone_squelch: false,
      dstar: false,
      fusion: false,
    ...
    create(:repeater,
      ...
      fm: true, fm_tone_burst: true, fm_ctcss_tone: nil, fm_tone_squelch: nil,
      dstar: false,
      fusion: true,
      dmr: false, dmr_color_code: nil, dmr_network: nil,
      nxdn: nil,
    ...
    create(:repeater,
      ...
      fm: true, fm_tone_burst: nil, fm_ctcss_tone: nil, fm_tone_squelch: nil,
      dstar: true,
      fusion: false,
      dmr: false, dmr_color_code: nil, dmr_network: nil,
      nxdn: nil,
    ...
    create(:repeater,
      ...
      fm: false, fm_tone_burst: nil, fm_ctcss_tone: nil, fm_tone_squelch: nil,
      dstar: true,
      fusion: false,
    ...
    create(:repeater,
      ...
      fm: true, fm_ctcss_tone: 71.9, fm_tone_squelch: false,
      dstar: true,
      fusion: true,
    ...
    create(:repeater,
      ...
      fm: true, fm_ctcss_tone: 77, fm_tone_squelch: false,
      dstar: false,
      fusion: false,
      dmr: false, dmr_color_code: nil, dmr_network: nil,
      nxdn: nil,
