...
RSpec.describe CsvExporter do
  ...
  it "should export" do
    ...
    expect(exporter.export).to eq(<<~CSV)
      ...
      Newcastle Emlyn,GB3CN,,GW6JSO,2m,true,145687500.0,145087500.0,true,,94.8,false,false,false,false,,,,,,51.99,-4.4,IO71TX,address,Newcastle Emlyn,Wales & Marches,SA44,gb,,,,,,,,,0:00,RV55,,ukrepeater.net,https://repeater.world/ukrepeater-net
      Weymouth,GB3DR,,G3VPF,2m,true,145737500.0,145137500.0,true,true,,,false,true,false,,,,,,50.55,-2.44,IO80SN,address,Weymouth,"South West, England",DT5,gb,,,,,,,,,0:00,RV59,,ukrepeater.net,
      Perth,GB3SF,,GM3NFO,2m,true,145625000.0,145025000.0,false,,,,false,true,false,,,,,,56.5,-3.4,IO86HK,address,Perth,Scotland,PH2,gb,,,,,,,,,0:00,RV50,,ukrepeater.net,
      Marlborough,GB7AE,,M1CJE,70cm,true,439425000.0,430425000.0,false,,,,true,false,false,,,,,,51.42,-1.76,IO91CJ,address,Marlborough,"South West, England",SN8,gb,,,,,,,,,0:00,DVU34,,ukrepeater.net,
      Derby,GB7DC,,G7NPW,70cm,true,430875000.0,438475000.0,true,,71.9,false,true,true,true,1,BRANDMEISTER,true,,,52.9,-1.4,IO92GW,address,Derby,"Midlands, England",DE21,gb,,,,,,,,,,RU70,Reduced output.,ukrepeater.net,
