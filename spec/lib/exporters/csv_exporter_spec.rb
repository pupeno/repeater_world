...
RSpec.describe CsvExporter do
  ...
  it "should export" do
    ...
    expect(exporter.export).to eq(<<~CSV)
      ...
      Repeater FU11,FU11,https://website,K3EPR,2m,true,144962500,144362500,true,true,true,67.0,true,true,C,true,true,1,Brandmeister,true,true,true,51.74,-3.42,IO81HR,address,city,region,PC,gb,50,tx_antenna,V,rx_antenna,V,200,150,bearing,05:00,channel,Notes,source,redistribution_limitations
