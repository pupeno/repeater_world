...
RSpec.describe IcomId51Exporter do
  ...
  it "should export" do
    exporter = IcomId51Exporter.new(build(:repeater_search).run)
    ...
    expect(exporter.export).to eq(<<~CSV)
      ...
      1,Japan,Made up,,JP0AA  A,JP0AA  G,439.420000,DUP-,9.000000,DV,OFF,88.5Hz,YES,Approximate,40.714353,-74.005973,--:--
      ...
      1,No Country,Repeater BL4NK,Missing Tone,BL4NK,,144.970000,DUP-,0.600000,FM,OFF,88.5Hz,YES,Approximate,,,--:--
      1,United Kingdom,Repeater FU11,city,FU11,,144.962500,DUP-,0.600000,FM,TONE,67.0Hz,YES,Approximate,51.740000,-3.420000,05:00
      1,United Kingdom,Repeater FU11,city,FU11   C,FU11   G,144.962500,DUP-,0.600000,DV,OFF,88.5Hz,YES,Approximate,51.740000,-3.420000,05:00
