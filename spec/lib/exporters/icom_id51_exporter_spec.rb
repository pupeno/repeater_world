...
RSpec.describe IcomId51Exporter do
  ...
  it "should export" do
    exporter = IcomId51Exporter.new(Repeater.order(:call_sign, :tx_frequency))
    ...
    expect(exporter.export).to eq(<<~CSV)
      ...
      1,Japan,Made up,,JP0AA  A,JP0AA  G,439.420000,DUP-,9.000000,DV,OFF,88.5Hz,YES,Approximate,,,--:--
    CSV
  end
end
