...
RSpec.describe IcomIc705Exporter do
  ...
  it "should export" do
    exporter = IcomIc705Exporter.new(build(:repeater_search).run)
    ...
    expect(exporter.export).to eq(<<~CSV)
      ...
      1,Japan,Made up,,JP0AA  A,JP0AA  G,439.420000,DUP-,9.000000,DV,,,YES,Approximate,40.714353,-74.005973,--:--
