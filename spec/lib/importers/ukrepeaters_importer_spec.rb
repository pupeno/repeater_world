...
RSpec.describe UkrepeatersImporter do
  ...
  it "should respect the source values during import" do
    Dir.mktmpdir("ukrepeatersimporter") do |dir|
      ...
      will_delete = create(:repeater, :full, call_sign: "GB7DC", tx_frequency: 145_000_001, source: UkrepeatersImporter::SOURCE)

      # This repeater represents one where the upstream data changed and should be updated by the importer.
      will_update = Repeater.find_by(call_sign: "GB3NL")
      ...
      wont_update = Repeater.find_by(call_sign: "GB3HI")
      ...
      # This got updated.
      will_update.reload
      expect(will_update.rx_frequency).to eq(145_175_000)
