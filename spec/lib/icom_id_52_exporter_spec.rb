  ...
  it "should export" do
    _repeaters = [
      ...
      create(:repeater,
        ...
        dmr: false, dmr_cc: nil, dmr_con: nil,
        nxdn: nil,
        grid_square: "JO01NI", latitude: 51.36, longitude: 1.15, country_id: "gb", region_1: "England", region_2: "South East", region_3: "CT6", region_4: "Herne Bay", source: "ukrepeater.net"),
      create(:repeater,
    ...
    expect(exporter.export).to eq(<<~CSV)
      ...
      1,United Kingdom,Herne Bay,No CTCSS,GB7IC C,,145.662500,DUP-,0.600000,FM,OFF,88.5Hz,YES,Approximate,51.360000,1.150000,--:--
      1,United Kingdom,Herne Bay,England,GB7IC  C,GB7IC  G,145.662500,DUP-,0.600000,DV,,,YES,Approximate,51.360000,1.150000,--:--
