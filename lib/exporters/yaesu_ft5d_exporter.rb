...
class YaesuFt5dExporter < Exporter
  def export
    ...
    @repeaters = @repeaters.where(band: [Repeater::BAND_2M, Repeater::BAND_70CM]) # TODO: can the FT5D do other bands? https://github.com/flexpointtech/repeater_world/issues/24
