...
class ChirpExporter < Exporter
  ...
  def to_repeater_row(repeater)
    row = {
      ...
      RX_DTCS_CODE => "023", # TODO: what's this? https://github.com/pupeno/repeater_world/issues/28
      CROSS_MODE => "Tone->Tone", # TODO: what's this? https://github.com/pupeno/repeater_world/issues/28
      MODE => "FM", # Always FM.
    ...
    if repeater.fm_ctcss_tone.present?
      row[TONE] = "Tone" # TODO: when do we use TSQL: https://github.com/pupeno/repeater_world/issues/23
    end
